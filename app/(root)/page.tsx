...
const HomePage = () => {
  ...
  return (
    <div className='h-screen bg-white'>
      <div className='py-10 px-20 h-[60vh] flex flex-col gap-8' style={{
        backgroundImage: `
  ...
  `,
        ...
        <div className='text-5xl font-bold'>
          ...
          <h3 className='text-[#0077b6]'>Reimagined</h3>
        </div>
        <div className='text-sm w-1/3'><p>
        ...
        <div className='flex gap-4'>
          <Button onClick={handleOnClick} className='bg-[#00b4d8] hover:bg-[#0096c7] text-white cursor-pointer'>Start Recording</Button>
          <Button onClick={() => router.push('/gallery')} className='bg-[#00b4d8] hover:bg-[#0096c7] text-white cursor-pointer'>View Gallery</Button>
        </div>
      </div>
